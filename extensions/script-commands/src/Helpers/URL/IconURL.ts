...
export const iconDarkURLFor = (scriptCommand: ScriptCommand) =>
  iconURL(scriptCommand, IconStyle.Dark)

export const iconLightURLFor = (scriptCommand: ScriptCommand) =>
  iconURL(scriptCommand, IconStyle.Light)
